...
export class GameRequirementsHeuristics {
  ...
  static GENRE_TEMPLATES = {
    ...
    'Competitive':   { min: { cpuScore: 15, gpuScore: 18, ram: 4, storage: 20, requiresSSD: false }, rec: { cpuScore: 45, gpuScore: 55, ram: 8, storage: 30, requiresSSD: false }, ultra: { cpuScore: 65, gpuScore: 75, ram: 8, storage: 40, requiresSSD: false } },
