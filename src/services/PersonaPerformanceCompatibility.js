...
class PersonaPerformanceCompatibility {
  ...
  static getSystemInfo() {
    ...
    try {
      ...
      console.warn('PersonaPerformanceCompatibility: unable to read cached system info', error);
    }
    ...
    if (stored) {
      try {
        ...
        console.warn('PersonaPerformanceCompatibility: failed to parse cached system info', error);
      }
    }
...
export { PersonaPerformanceCompatibility };
